...
- [x] **매시 백업 무결성 게이트**([devlog 150](devlog/20260715_150_hourly-integrity-gate.md), 0.1.68 양 서버 배포·실측 검증) —
  ...
  - [ ] **3-repo 포팅** — fcmanager·fsis2026 의 `backup_db.py` 에 같은 게이트([devlog 147](devlog/20260714_147_three-repo-consistency-align.md)
        이 동형화해둔 걸 cdGTS 가 선행 = **의도적 이탈**). 두 repo 는 nginx tar 등 소스가 더 많아 조사 선행.
