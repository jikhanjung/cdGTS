...
**Last updated**: 2026-07-13. 운영 `cdgts.paleobytes.info`(dolfinid-2) @ **0.1.59** · 테스트 서버 **m710q**(tailscale serve → `127.0.0.1:8011`) @ **0.1.59**. 이미지 `honestjung/cdgts:0.1.35~0.1.59` dockerhub push 완료. 공개 `https://cdgts.paleobytes.info/healthz` = 0.1.59/node_types 17.
