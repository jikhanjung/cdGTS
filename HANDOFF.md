...
**Last updated**: 2026-07-13. 운영 `cdgts.paleobytes.info`(dolfinid-2) @ **0.1.57** 배포 완료 · 테스트 서버 **m710q**(tailscale serve → `127.0.0.1:8011`) @ **0.1.57**. 이미지 `honestjung/cdgts:0.1.35~0.1.57` dockerhub push 완료. 둘 다 git-free `deploy-{prod,dev}.sh` + smoke green(node_types 17) 검증.
