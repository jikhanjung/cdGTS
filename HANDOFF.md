...
**Last updated**: 2026-07-13. 운영 `cdgts.paleobytes.info`(dolfinid-2) @ **0.1.58** · 테스트 서버 **m710q**(tailscale serve → `127.0.0.1:8011`) @ **0.1.58**. 이미지 `honestjung/cdgts:0.1.35~0.1.58` dockerhub push 완료. 둘 다 배포·smoke green 검증(공개 `https://cdgts.paleobytes.info/healthz` = 0.1.58/node_types 17).
