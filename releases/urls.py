...
from .views import (
    GraphBakeView, GraphProposeView, GraphVerifyView, IccChartView,
    ProposalViewSet, ReleaseIccChartView, ReleaseNarrateView, ReleaseViewSet,
)
...
urlpatterns = router.urls + [
    ...
    path("graphs/<int:pk>/propose/", GraphProposeView.as_view(), name="graph-propose"),
